...
#		And the balance of the merchant at the bank is 2100 kr
	...
	Scenario: Successful Payment Baseline
		Given a customer registered with DTU Pay with balance 1000
		And a token that is associated with the customer
		Given a merchant registered with DTU Pay with balance 2000
		When the merchant requests a transaction for 100 kr by the customer
